  ...
  return (
    <div className="app archive-page">
      <header className="app-header">
        ...
        <p className="tagline">Replay any past day. Archived plays don’t affect your daily streak.</p>
      </header>

      <main className="play-area archive-list">
        {dates.length === 0 ? (
          <p className="archive-empty">No past puzzles yet — check back tomorrow!</p>
        ) : (
          dates.map((date) => (
