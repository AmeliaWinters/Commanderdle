...
export default function TermsPage() {
  return (
    ...
    >
      ...
      <section>
        <p>
          By accessing or using Commandle (the &ldquo;site&rdquo;) you agree to
          these Terms of Service. If you do not agree, please do not use the
          site. We may update these terms from time to time; the
      ...
      <section>
        ...
        <p>
          ...
          non-commercial entertainment. We may add, change, suspend or
      ...
      <section>
        ...
        <p>
          ...
          Wizards&rsquo; Fan Content Policy and is not affiliated with, endorsed
          ...
          , subject to their respective terms. The game&rsquo;s own code,
      ...
      <section>
        ...
        <p>
          ...
          between you and them; we are not responsible for the content, products
          or services of any advertiser. See our{" "}
      ...
      <section>
        ...
        <p>
          ...
          implied. We do not warrant that the game will be uninterrupted,
